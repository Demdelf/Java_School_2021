            ...
            <div class="tab-content py-4">
                ...
                <c:forEach items="${orderDtoList}" var="order">
                    ...
                    <div class="row  mb-3">
                        ...
                        <div class="col-md-3 themed-grid-col">кол-во товаров: <strong>${order.numberOfProducts}</strong>
                        </div>
                        <div class="col-md-2 themed-grid-col">${order.deliveryStatus}</div>
                        <div class="col-md-3 themed-grid-col">${order.deliveryMethod}</div>
                        <div class="col-md-2 themed-grid-col">${order.fullCost} <strong>$</strong></div>
