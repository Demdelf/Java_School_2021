    ...
    <section class="py-5 text-center container">
        <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
                <h1 class="fw-light">Drytooling holds</h1>
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary" href="/cart/add/${product.id}">Add to cart</button>
                                        <button type="button" class="btn btn-sm btn-outline-secondary" href="/customer/products/${product.id}">View</button>
                                    </div>
...
<%--<script src="/webjars/bootstrap/5.0.0-beta1/js/bootstrap.bundle.min.js"></script>--%>
